...
int runPart2A_Path(Battlefield *bf, double *pathX, double *pathY, int k,
    ...
    for (int i = 0; i < k && !sunk; i++) {
        ...
        // Step 1: build this iteration's candidate list (escorts B can hit from here).
        ...
        // Step 2: sort - imminent threats first, then non-threats.
        ...
        // Step 3: fire in order, respecting reload time (clock restarts each iteration).
        ...
        // Step 4: sort this iteration's successful hits by time, apply cumulative damage.
