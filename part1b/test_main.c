...
int main(void) {
    ...
    printf("\n--- Simulation 1 (no jam) ---\n");
    runSimulationPath(&bf, pathX, pathY, k, 0, 0, 0, "sim1_result.txt");

    // Reset escort states for a fresh Simulation 2 run using the same setup
    ...
    printf("\n--- Simulation 2 (jammed gun after iteration %d) ---\n", t);
    runSimulationPath(&bf, pathX, pathY, k, 1, t, thetaMin, "sim2_result.txt");
