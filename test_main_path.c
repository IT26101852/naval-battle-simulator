...
int main(void) {
    ...
    printf("\n--- Simulation 1 (no jam, cumulative damage) ---\n");
    runPart1C_Path(&bf, pathX, pathY, k, 0, 0, 0, "part1c_sim1_result.txt");
    ...
    printf("\n--- Simulation 2 (jammed gun, cumulative damage) ---\n");
    runPart1C_Path(&bf, pathX, pathY, k, 1, t, thetaMin, "part1c_sim2_result.txt");
